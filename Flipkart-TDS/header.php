...
<head>
    ...
    <title>TdesWorld Online Shopping Site for Mobiles, Electronics & More. Best Offers!</title>
    <meta name="og_title" property="og:title" content="TdesWorld Shopping Site for Mobiles, Electronics &amp; More. Best Offers!">
    <meta name="Keywords" content="Flipkart Clone,Flipkart PHP,TdesWorld Jigar Sable,Jigar,TdesWorld PHP,ecommerce PHP,PHP Projects,Online Shopping in India,online Shopping store,Online Shopping Site,Buy Online,Shop Online,Online Shopping,Flipkart">
...
<!-- header starts -->
<header class="bg-primary-orange fixed top-0 py-2.5 w-full z-10">
    ...
    <div class="w-full sm:w-9/12 px-4 m-auto flex justify-between items-center relative">
        ...
        <a class="h-7 mr-4" href="<?php echo $URL; ?>/index.php">
            ...
            <img draggable="false" loading="lazy" class="h-full w-full object-contain" src="assets/images/tdslogo.jpg" alt="Logo">
        </a>
